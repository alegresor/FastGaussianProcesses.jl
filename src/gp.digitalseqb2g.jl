...
function kernel_digital_s1(x1b::UInt64,x2b::UInt64,β1::Int64,β2::Int64,α::Int64,t::Int64)
    xb = x1b ⊻ x2b
    x = xb * 2. ^(-t)
...
function kernel_digital(x1b::Vector{UInt64},x2b::Vector{UInt64},α::Int64,γ::Float64,η::Vector{Float64},β1::Vector{Int64},β2::Vector{Int64},s::Int64,t::Int64)
    kvals = map(j->kernel_digital_s1(x1b[j],x2b[j],β1[j],β2[j],α,t),1:s)
